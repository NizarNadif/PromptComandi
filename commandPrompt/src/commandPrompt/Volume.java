...
public class Volume implements Serializable{
    ...
    //cartella nella quale ci si trova attualmente
    private NodoAlbero attuale;
    //percorso assoluto di tale cartella
    ...
    public void removeDirectory (String percorso){
        ...
        if (!changeDirectory(percorso)){
            this.percorso = percorsoAttuale;
            return;
        }
        if (attuale == posizioneAttuale){
            System.out.println("Opzione non valida - \"" + attuale.getNome() + "\".");
            this.percorso = percorsoAttuale;
            return;
        }
