...
public class GestoreUnità implements Serializable{
    ...
    public void run(){
        ...
        while (true){
            ...
            //rimpiazzo tutti gli eventuali gruppi di spazi, rappresentati da \\s+, con un unico spazio e infine divido l'input.
            ...
            if (input[0].equalsIgnoreCase("exit")){
                ...
                switch(input[0].toUpperCase()) {
                    ...
                    case "HELP":
                        flag = false;
                        try{
                            System.out.println(unità[unitàAttuale].help(input[1]));
                        }catch(ArrayIndexOutOfBoundsException exception){
                            System.out.println(
                    ...
                    case "RD": case "RMDIR": 
                        try{
                            ...
                            System.out.println("Sintassi del comheando errata.");
                        }
                        break;
